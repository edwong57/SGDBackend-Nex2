...
class OneAnnotation extends Component {
  ...
  render() {
    return (
      <div>
        {/* reference */}
        <TextFieldSection sec_title='Reference (SGDID, PMID, Reference_id, eg. SGD:S000185012, PMID:27650253, 307729)' name='reference_id' value={this.props.phenotype.reference_id} onOptionChange={this.props.onOptionChange} />
        ...
        <a href='https://www.yeastgenome.org/ontology/phenotype/ypo' target='new'>Yeast Phenotype Ontology</a>
