...
class OneConditionGroup extends Component {
  ...
  render() {
    return (
      <div>
        {/* Chemicals */}
        <ConditionSection sec_title='Chemical(s) (Enter CHEBI ID (eg, CHEBI:5856)) ("|" delimited)' class='chemical' name={this.props.phenotype.chemical_name} value={this.props.phenotype.chemical_value} unit={this.props.phenotype.chemical_unit} onOptionChange={this.props.onOptionChange} /><a href='https://www.ebi.ac.uk/chebi/' target='new'>Search Chebi Ontology</a><p></p>
