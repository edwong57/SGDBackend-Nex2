    ...
    return (
      <div>
        <form onSubmit={this.handleGetAnnotations} ref='form'>
          ...
          <TextFieldSection sec_title='Reference (SGDID, PMID, Reference_id, eg. SGD:S000185012, PMID:27650253, 307729)' name='reference' value={this.props.phenotype.reference} onOptionChange={this.handleChange} />
