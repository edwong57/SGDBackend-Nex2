      ...
      <form onSubmit={this.handleSubmit} ref='form'>
        <div className='row'>
          ...
          <div className='columns medium-6 end'>
            <a href='https://docs.google.com/spreadsheets/d/1DNI7OQyqWZvKCHrCRb_tOFYqZ5DYxnHihW5h0b_dPtw/edit?usp=sharing' rel="noopener noreferrer" target='_blank' >Disease template file </a>
          </div>
        </div>
